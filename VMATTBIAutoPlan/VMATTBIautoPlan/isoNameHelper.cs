        ...
        public List<string> getIsoNames(int numVMATIsos, int numIsos)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else if (numVMATIsos == 5) { isoNames.Add("Pelvis"); isoNames.Add("Legs_Sup"); isoNames.Add("Legs_Inf"); }
                    else if (numVMATIsos == 6) { isoNames.Add("Pelvis"); isoNames.Add("Legs_Sup"); isoNames.Add("Legs_Inf"); isoNames.Add("Feet"); }
                }
            }
            return isoNames;
        }
